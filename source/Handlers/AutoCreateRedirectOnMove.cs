...
namespace SharedSource.RedirectModule.Handlers
{
    public class AutoCreateRedirectOnMove
    {
        protected void OnItemMoved(object sender, EventArgs args)
        {
            ...
            if (Sitecore.Configuration.Settings.GetBoolSetting(Constants.Settings.RedirectRootNode, true) && Sitecore.Configuration.Settings.GetBoolSetting(Constants.Settings.AutoGenerateRedirectsOnMove, true))
            {
